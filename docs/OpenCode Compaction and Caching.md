...
- OpenCode itself is pinned to `1.18.9` in `flake.nix`. Recheck upstream behavior
...
In OpenCode `1.18.9`, pruning skips recent turns and protected tools, preserves
...
[`compaction.ts` source](https://github.com/anomalyco/opencode/blob/v1.18.9/packages/opencode/src/session/compaction.ts).
...
[`session.ts`](https://github.com/anomalyco/opencode/blob/v1.18.9/packages/opencode/src/session/session.ts),
and the overflow calculation is in
[`overflow.ts`](https://github.com/anomalyco/opencode/blob/v1.18.9/packages/opencode/src/session/overflow.ts).
...
truncation limits applied when tools return output. OpenCode `1.18.9` defaults to
...
[`truncate.ts`](https://github.com/anomalyco/opencode/blob/v1.18.9/packages/opencode/src/tool/truncate.ts).
