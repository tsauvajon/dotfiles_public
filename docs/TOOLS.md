...
| `opencode-reap`          | `home/programs/scripts.nix`        | URL-scoped stale orphan OpenCode attach cleanup    | `opencode-reap`, `opencode-reap --apply`                      |
...
| `opencode-server-status` | `home/programs/scripts.nix`        | Shared server diagnostics and deferred restarts    | `opencode-server-status`                                      |
