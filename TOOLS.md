...
| `backup` | `home/programs/scripts.nix` | Copy a file to `<file>.bak` | `backup config.toml` |
...
| `tabiew` | `home/fs.nix` | TUI for viewing tabular data | `tw data.csv`, `tabiew data.csv` |
